...
* **1. For ALX School loop**
  * [1-for_ALX_school](./1-for_holberton_school): Bash script that displays
  `Holberton School` 10 times using a `for` loop.

* **2. While ALX School loop**
  * [2-while_ALX_school](./2-while_holberton_school): Bash script that
  displays `ALX School` 10 times using a `while` loop.

* **3. Until ALX School loop**
  * [3-until_ALX_school](./3-until_holberton_school): Bash script that displays
  `ALX School` 10 times using an `until` loop.
